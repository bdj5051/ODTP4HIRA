...
tcos <- read.csv(system.file("settings", "TcosOfInterest.csv", package = "ODPT4HIRA8"))
analysisIdList <- unique(omr$analysisId)
outcomeIds <- c(1102,1103,1104,1105,1106)
...
getOutcomesOfInterest <- function() {
  pathToCsv <- system.file("settings", "TcosOfInterest.csv", package = "ODPT4HIRA8")
