with osteoporosis as (
	...
	select co.person_id, p.year_of_birth, min(co.condition_start_date) as condition_start_date 
...
select po.*, year(po.condition_start_date)-po.year_of_birth as age from person_osteoporosis po;
