...
from (
  ...
  WHERE de.drug_concept_id IN (40173612, 21604152, 42943685, 40174494, 21604155) 
	AND de.days_supply >= 4
union all
  SELECT de.person_id, de.drug_concept_id, de.drug_exposure_start_date, de.drug_exposure_end_date, de.days_supply, 30 AS duration
  FROM @cdm_database_schema.DRUG_EXPOSURE de
  WHERE de.drug_concept_id IN (40174364, 40174486)
