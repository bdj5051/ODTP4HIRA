...
from (
  SELECT de.person_id, de.drug_concept_id, de.drug_exposure_start_date, de.drug_exposure_end_date, de.days_supply, 1 AS duration
  FROM @cdm_database_schema.DRUG_EXPOSURE de
  WHERE de.drug_concept_id IN (41181419, 21602626, 44814412, 21602625)
    AND de.days_supply >= 28
  ) d;
